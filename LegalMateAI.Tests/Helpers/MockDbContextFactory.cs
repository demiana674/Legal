// LegalMateAI.Tests/Helpers/MockDbContextFactory.cs
...
namespace LegalMate.Tests.Helpers
{
    public static class MockDbContextFactory
    {
        ...
        public static async Task<LegalMateDbContext> CreateSeededDbContext()
        {
            ...
            // ✅ Seed Law
            context.Laws.Add(TestDataFactory.CreateTestLaw());
            
            // ✅ Seed Lawyer Branch
            context.LawyerBranches.Add(TestDataFactory.CreateTestLawyerBranch(lawyerProfile.Id));
